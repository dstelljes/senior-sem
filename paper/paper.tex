...
\begin{figure}[ht]
  \centering
  \resizebox{\linewidth}{!}{\input{../figures/single-thread-read-write.tikz}}
...
\begin{figure}[ht]
  \centering
  \resizebox{\linewidth}{!}{\input{../figures/multiple-threads-read-write.tikz}}
...
\begin{figure}[ht]
  \centering
  \resizebox{0.63\linewidth}{!}{\input{../figures/noninstantaneity.tikz}}
...
\begin{figure}[ht]
  \centering
  \resizebox{0.63\linewidth}{!}{\input{../figures/linearizability.tikz}}
...
\begin{figure}[ht]
  \centering
  \resizebox{0.63\linewidth}{!}{\input{../figures/serializability.tikz}}
...
\begin{figure}[ht]
  \centering
  \resizebox{0.63\linewidth}{!}{\input{../figures/obmop.tikz}}
