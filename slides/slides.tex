...
\begin{document}
  ...
  \begin{frame}
    ...
    \textbf{What characteristics should a unified abstraction have?}~\footcite{Marr2012}
    ...
    \begin{itemize}
      ...
      \vfill
      \onslide<2->{
        \item Managed mutation and execution: The owner of an object should determine how it be read and modified.
      }
      \vfill
      \onslide<3->{
      ...
      \vfill
      \onslide<4->{
        \item Enforceability: The model's semantics should be enforced regardless of where the model is used.
      }
    \end{itemize}
  \end{frame}
